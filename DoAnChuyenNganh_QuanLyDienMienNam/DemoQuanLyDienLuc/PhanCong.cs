    ...
    public partial class PhanCong : Form
    {
        ...
        private void btnPhanCong_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Kiểm tra ngày lắp đặt không được nhỏ hơn ngày hiện tại
                if (ngayLapDat.Date < DateTime.Now.Date)
                {
                    MessageBox.Show("Ngày lắp đặt không được nhỏ hơn ngày hiện tại!", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
        ...
        private void GuiEmailThongBao(string maKhachHang, string tenKhachHang, string email, DateTime ngayLapDat, string diaChi)
        {
            try
            {
                ...
                {
                    client.DefaultRequestHeaders.Add("api-key", "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");
